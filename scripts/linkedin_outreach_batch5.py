...
PROFILES_JSON = VAULT_ROOT / "active_application_context" / "proposed_batch5.json"
PROGRESS_FILE = VAULT_ROOT / "active_application_context" / "linkedin_outreach_progress_batch5.json"
        ...
        with sync_playwright() as p:
            ...
            for i, profile in enumerate(profiles):
                ...
                if status_result == "SENT":
                    log_to_tracker(company, name, "Invite Sent", f"SENT (Outreach Batch 5)")
